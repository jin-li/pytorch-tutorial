...
def language_model(device, data_source="../data/wikitext-2", epochs=50, batch_size=20, eval_batch_size=10, lr=20, emsize=200, nhid=200, nlayers=2, seq_len=35, dropout=0.2, tied=False, save='model.pt', plot=False):
    ...
    model = LanguageLSTM('LSTM', ntokens, emsize, nhid, nlayers, dropout, tied).to(device)
...
if __name__ == '__main__':
    ...
    train_losses, val_losses = language_model(device, args.data, args.epochs, args.batch_size, args.eval_batch_size, args.lr, args.emsize, args.nhid, args.nlayers, args.seq_len, args.dropout, args.tied, args.save, args.plot)
